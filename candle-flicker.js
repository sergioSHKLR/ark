(function () {
  function css() {
    ...
    s.textContent =
      ...
      "html[data-theme='dark'] .candle-flame,.candle-btn.is-lit .candle-flame{opacity:1;animation:flame-flicker 1.15s ease-in-out infinite}" +
  ...
  function mount() {
    ...
    if (lit && !document.documentElement.getAttribute("data-theme"))
